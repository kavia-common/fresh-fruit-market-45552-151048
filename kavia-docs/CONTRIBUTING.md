...
- Tests for components, pages, and (future) API client.
...
1) Create a branch
- Use a descriptive name: feature/theme-persistence, fix/test-flakes, docs/architecture-update.

2) Make your changes
- Follow the style guide (Ocean Professional palette, subtle retro accents).
...
4) Commit Messages
- Use clear, imperative messages: “Add theme toggle aria-label” or “Fix dark mode contrast in buttons”.
...
- Data fetching (future):
  - Add functions to src/api/client.js. Reuse fetchWithTimeout and environment-based base URL selection.
...
- When switching from HashRouter to BrowserRouter in the future, configure host routes accordingly.
